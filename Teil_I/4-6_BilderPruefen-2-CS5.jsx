...
for (var i = 0; i < _alleBilder.length; i++) {
	...
	// Falls ein Fehler gefunden wurde, ist in der Variablen nicht mehr der leere String gespeichert. 
	if (_fehler) {
		app.activeWindow.activePage = _bildRahmen.parentPage; // Nur CS5
